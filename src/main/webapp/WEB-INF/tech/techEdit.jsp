										...
										<div class="col-6 col-12-small">
											<div class="row gtr-50">
												...
												<div id = "content" class="col-6 col-12-medium">
													...
													<div class="col-12 col-12-small" style = "text-align:left;">
														<h6>font</h6>
														<select name = "STYLE_FONT2" id = "STYLE_FONT2" >
															<c:forEach var = "v" items = "${font}">
																<c:if test="${v.CODE_NAME == data.STYLE_FONT2}">
																	<option value = "${v.CODE_NAME}" style = "font-family:${v.CODE_NAME};" selected>${v.CODE_EXPL}</option>
																</c:if>
														...
														<h6>size</h6>
														<input type = "number" id = "STYLE_SIZE2" name = "STYLE_SIZE2" value = "${data.STYLE_SIZE2}" style = "width:40px; height:20px; font-size: 15px; "/>
														<h6>space</h6>
														<input type = "number" id = "STYLE_SPACE2" name = "STYLE_SPACE2" value = "${data.STYLE_SPACE2}" style = "width:40px; height:20px; font-size: 15px; "/>
														<h6>weight</h6>
														<select name = "STYLE_WEIGHT2" id = "STYLE_WEIGHT2" >
															<c:forEach var = "v" items = "${bold}">
																<c:if test="${v.CODE_NAME == data.STYLE_WEIGHT2}">
																	<option value = "${v.CODE_NAME}" style = "font-weight:${v.CODE_NAME};" selected>${v.CODE_EXPL}</option>
																</c:if>
													...
													<div>
														<textarea id = "POST_TXT" name="POST_TXT" placeholder="Content">${data.POST_TXT}</textarea>
													</div>
												</div>
